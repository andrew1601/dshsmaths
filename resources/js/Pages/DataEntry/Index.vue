<template>
    <layout>
        ...
        <div class="form-group" v-if="(selectedTest >= 0) && (selectedPaper >= 0) && (selectedTeachingGroup >= 0)">
            <inertia-link :href="`/data-entry/paper/${selectedPaper}/teaching-group/${selectedTeachingGroup}`" class="btn btn-primary full-width-button">Open Spreadsheet</inertia-link>
        </div>
    </layout>
</template>
